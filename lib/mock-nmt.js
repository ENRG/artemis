...
MockNMT.prototype.listen = function(){
...
MockNMT.prototype.startStreaming = function(){
  var this_ = this;
  console.log("MockNMT.startStreaming");
...
MockNMT.prototype.onSocketReceived = function( socket ){
  console.log( 'MockNMT listening on port', this.options.port );
  ...
  if ( !this.isLoggedIn() ) this.socket.write( '* ' );
};
